    ...
    <form id="form1" runat="server">
        <div class="CentrarContenido">
            <div class="Contenedor">
                ...
                <asp:Label ID="lblTituloAgregar" runat="server" CssClass="Titulo" Text="Agregar los datos del paciente"></asp:Label>
                ...
                <asp:TextBox ID="txtFechaNacimiento" runat="server" CssClass="TextBoxFecha" TextMode="Date"></asp:TextBox>

            ...
            <div class="Contenedor">
                <div class="Fila">
                    ...
                    <div class="Columna40-Hyperlink">
                        <asp:HyperLink ID="hlVolver" runat="server" NavigateUrl="~/MenuAdministrador.aspx" CssClass="HyperLink">Volver al menú</asp:HyperLink>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <asp:TextBox ID="calNacimiento" runat="server" CssClass="TextBoxFecha" TextMode="Date"></asp:TextBox>
